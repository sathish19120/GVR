      ...
      <div style={{
        ...
        {error && (
          <div style={{
            ...
            <button onClick={clearError} style={{ background: 'none', border: 'none', color: '#FCA5A5', cursor: 'pointer', fontSize: '16px', paddingLeft: '8px' }}>✕</button>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
              ...
              {mode === 'login' && (
                <a href="mailto:admin@greenvillagerice.in?subject=Password Reset"
                   style={{ color: 'rgba(255,255,255,0.4)', fontSize: '11px', textDecoration: 'underline' }}>
                  Forgot password?
                </a>
              )}
            </div>
                ...
                <input
                  ...
                  style={{
                    ...
                    borderColor: confirmPassword && password !== confirmPassword
                      ? 'rgba(220,38,38,0.6)' : 'rgba(255,255,255,0.15)'
                  }}
                  onFocus={e => (e.target.style.borderColor = 'rgba(192,221,151,0.7)')}
        ...
        <p style={{
          ...
          fontSize: '11px', marginTop: '28px', marginBottom: 0
        }}>
