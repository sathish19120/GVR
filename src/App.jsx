...
// Import Toast — if this file doesn't exist yet the build will fail,
// so we import it directly. Make sure src/components/Toast.jsx is in the repo.
  ...
  return (
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'#F4F6F3' }}>
      <div style={{ textAlign:'center' }}>
        <div style={{ width:64, height:64, borderRadius:16, background:'#3B6D11', display:'flex', alignItems:'center', justifyContent:'center', fontSize:32, margin:'0 auto 16px' }}>🌾</div>
        <p style={{ color:'#3B6D11', fontWeight:700, fontSize:16, margin:'0 0 6px' }}>Green Village Rice</p>
        <p style={{ color:'#6B7280', fontSize:13, margin:0 }}>గ్రీన్ విలేజ్ రైస్</p>
      </div>
    </div>
  )
}
