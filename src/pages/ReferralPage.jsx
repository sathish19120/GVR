    ...
    <div style={{ fontFamily:"'Inter',sans-serif", maxWidth:600, margin:'0 auto' }}>
      ...
      <div style={{ background:G.white, borderRadius:16, padding:'20px 22px', marginBottom:16, boxShadow:'0 1px 4px rgba(0,0,0,0.06)' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
          ...
          <button onClick={copyCode} style={{ padding:'12px', background:G.blueLight, color:G.blue, border:'none', borderRadius:12, fontSize:14, fontWeight:700, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:8 }}>
