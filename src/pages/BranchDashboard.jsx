...
export default function BranchDashboard() {
  ...
  async function load() {
    setLoading(true)
    // FIX: orders query now filters by this executive's own branch.
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', minWidth:0 }}>
        ...
        <main className='branch-main' style={{ flex:1, padding:'22px', overflowY:'auto', minWidth:0, height:'100%' }}>
          ...
          {page === 'orders' && <>
            ...
            <div style={{ background:G.blueLight, borderRadius:10, padding:'8px 14px', marginBottom:14, fontSize:12, color:G.blue }}>
              📍 Showing orders for <strong>{branch}</strong> branch only
            </div>
